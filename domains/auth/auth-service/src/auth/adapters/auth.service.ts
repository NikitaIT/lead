...
import { AuthService, JwtPayload } from '../ports';
import { InjectRepository } from '@nestjs/typeorm';
import { Repository } from 'typeorm';

@Injectable()
export class PersistedUserAuthService implements AuthService {
  constructor(
  ...
  async validateJwtPayload(
    ...
    const user = await this.userRepo.findOneBy({
      lowercaseUsername: payload.username.toLowerCase(),
    });
